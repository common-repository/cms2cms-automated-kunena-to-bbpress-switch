<?php
if (!defined('CMS2CMS_KUNENA_VERSION')) {
    die();
}
...
$key              = get_option('cms2cms-kunena-key');
$activated        = $dataProvider->isActivated();
$targetUrl        = get_site_url();
$authentication   = $dataProvider->getAuthData();
$ajaxNonce        = $dataProvider->getFormTempKey('cms2cms-kunena-ajax-security-check');
$currentPluginUrl = plugin_dir_url(__FILE__);
$jsConfig         = $dataProvider->getConfig(true);
$config           = $dataProvider->getConfig();

$loader           = new CmsBridgeKunenaLoader();
$styles = array($dataProvider->getFrontUrl() . 'css/cms2cms.css?v=' . CMS2CMS_KUNENA_VERSION);
foreach ($styles as $style) {
    printf('<link rel="stylesheet" href="%s" type="text/css" media="all">', $style);
}

$scripts = array(
    $dataProvider->getFrontUrl() . 'js/jsonp.js?v=' . CMS2CMS_KUNENA_VERSION,
    $dataProvider->getFrontUrl() . 'js/cms2cms.js?v=' . CMS2CMS_KUNENA_VERSION
);
...
?>
<div class="wrap cms2cms-kunena-wrapper">
    <div class="cms2cms-kunena-container">
        <div class="cms2cms-kunena-header">
        ...
        <?php if ($activated) { ?>
            <script language="JavaScript">
                jQuery('.cms2cms-kunena-container').addClass('cms2cms_kunena_is_activated');
            </script>
            <div class="cms2cms-kunena-message">
                <span>
                    <?php echo sprintf(
                        $dataProvider->__('You are logged in CMS2CMS as %s', $fileStart),
                        get_option('cms2cms-kunena-login')
                    ); ?>
                </span>
                <div class="cms2cms-kunena-logout">
                    <form action="" method="post" id="logout" data-logout="<?php echo $dataProvider->getLogOutUrl() ?>">
                        <input type="hidden" name="cms2cms_kunena_logout" value="1"/>
                        <input type="hidden" name="_wpnonce"
                               value="<?php echo $dataProvider->getFormTempKey('cms2cms_kunena_logout') ?>"/>
                        <button class="button-grey cms2cms-kunena-button" data-log-this="Logout" type="button">
        ...
        <?php } ?>
        <div class="cms2cms-kunena-plugin">
            <div id="cms2cms_kunena_accordeon">
                ...
                <?php
                $cms2cms_kunena_step_counter = 1;
                if (!$activated) { ?>
                    <div id="cms2cms_kunena_accordeon_item_id_<?php echo $cms2cms_kunena_step_counter++; ?>"
                         class="step-body cms2cms_kunena_accordeon_item cms2cms_kunena_accordeon_item_register">
                        ...
                        <form action="<?php echo $dataProvider->getLoginUrl() ?>"
                              ...
                              class="step_form"
                              id="cms2cms_kunena_form_register">
                            <div class="center-content">
                                <div class="error_message"></div>
                                <div class="user-name-block" style="display: none">
                                    <label
                                            for="cms2cms-kunena-user-name"><?php $dataProvider->_e('Full Name', $fileStart); ?></label>
                                    <input type="text" maxlength="50" id="cms2cms-kunena-user-name" name="name"
                                           value="" placeholder="Your name" class="regular-text"/>
                                    <div class="cms2cms-kunena-error name">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>
                                <div>
                                    <label
                                            for="cms2cms-kunena-user-email"><?php $dataProvider->_e('Email', $fileStart); ?></label>
                                    <input type="text" id="cms2cms-kunena-user-email" name="email"
                                           value="" placeholder="Your email" class="regular-text"/>
                                    <div class="cms2cms-kunena-error email">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>
                                <div>
                                    <label
                                            for="cms2cms-kunena-user-password"><?php $dataProvider->_e('Password', $fileStart); ?></label>
                                    <input type="password" id="cms2cms-kunena-user-password" name="password" value=""
                                           placeholder="Your password" class="regular-text"/>
                                    <div class="cms2cms-kunena-error password">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>

                                <input type="hidden" id="cms2cms-kunena-user-plugin" name="referrer"
                                       value="<?php echo $dataProvider->getPluginReferrerId(); ?>"
                                       class="regular-text"/>
                                <input type="hidden" id="cms2cms-kunena-site-url" name="siteUrl"
                                ...
                                <button
                                        ...
                                        type="button" id="auth_submit" class="cms2cms-kunena-button button-green">
                                ...
                                <a data-log-this="Forgot Password Link clicked"
                                   ...
                                   class="cms2cms-kunena-real-link" >
                ...
                <?php } /* cms2cms_kunena_is_activated */ ?>
                ...
                <div id="cms2cms_kunena_accordeon_item_id_<?php echo $cms2cms_kunena_step_counter++; ?>"
                     class="step-body cms2cms_kunena_accordeon_item">
                    <?php if (isset($message)) {?>
                        <div class="container-erorr-1">
                            <div class="block-erorr alert r-b-e">
                                <?php $dataProvider->_e(sprintf('%s Please contact our', $message), $fileStart); ?>
                    ...
                    <form action="<?php echo $dataProvider->getWizardUrl(); ?>"
                          method="post"
                          id="cms2cms_kunena_form_estimate">
                        <div class="center-content">
                            <div class="error_message"></div>
                            <div id='error'></div>
                            <p><?php $dataProvider->_e('Choose between the installation of', $fileStart); ?>
                                <a href="<?php echo $dataProvider->getExtensionUrl(); ?>"><?php $dataProvider->_e('the Connector Extension', $fileStart); ?> </a> or <a href="<?php echo $dataProvider->getBridgeUrl(); ?>"><?php $dataProvider->_e('the Connection Bridge.', $fileStart); ?> </a><br>
                                <?php $dataProvider->_e('For more information, please', $fileStart); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="sourceUrl" name="sourceUrl" value="" class="regular-text"
                                       ...
                                       ?>"/>
                                <div class="cms2cms-kunena-error">
                                    <div class="error-arrow"></div>
                                    <span></span></div>
                            </div>
                            ...
                            <input type="hidden" id="key" name="key"
                                   value="<?php echo $key; ?>"/>
                            <button id="verifySource_kunena"
                                    data-log-this="Verify Source Button pressed"
                                    type="button" name="verify-source" class="cms2cms-kunena-button button-green">
                                <?php $dataProvider->_e('Verify Connection', $fileStart); ?>
                            </button>
                        </div>
                    </form>
                    <div class="cms2cms-kunena-error"></div>
                </div>
            </div>
        </div> <!-- /plugin -->
